---
id: TASK-2
title: 'Phase 2 — GPU: vLLM + Dana plugins on rented hardware'
status: To Do
assignee: []
...
<!-- SECTION:NOTES:BEGIN -->
migrated from PHASE_2_GPU.md (kept in place at repo root as canonical spec). Blocked by Phase 1 exit gate.
<!-- SECTION:NOTES:END -->
