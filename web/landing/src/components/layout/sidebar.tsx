...
const navItems = [
  ...
  { href: "/dashboard/keys", label: "کلیدهای API", icon: Key },
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-800 space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-gradient-to-bl from-dana-400 to-dana-600 flex items-center justify-center text-white text-xs font-bold">ک</div>
            <div>
              <p className="text-xs font-medium text-gray-900 dark:text-gray-100">کاربر نمونه</p>
              <p className="text-[10px] text-gray-500 dark:text-gray-400">user@example.com</p>
            </div>
          </div>
          <ThemeToggle />
        </div>
        <button className="flex items-center gap-2 w-full px-3 py-2 rounded-xl text-sm text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900 transition-colors cursor-pointer">
